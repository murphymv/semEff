...
total effects for 'piecewise' structural equation models, comprising lists of
...
in R for ecology, evolution, and systematics. *Methods in Ecology and
Evolution*, **7**(5), 573–579. https://doi.org/f8s8rb
* Shipley, B. (2000). A New Inferential Test for Path Models Based on Directed
Acyclic Graphs. *Structural Equation Modeling: A Multidisciplinary Journal*,
**7**(2), 206–218. https://doi.org/cqm32d
